...
Use o subagente `itachi` para a revisao somente leitura de licencas, segredos e atribuicoes. Nao declare equivalencia completa se verificacoes essenciais nao puderam ser executadas. Os slash commands desta skill sao `/sharingan-check` e `/sharingan-audit`, nao `/sharingan-validate`.
