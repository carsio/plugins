...
Delegue analise somente leitura ao subagente `transplant-planner`. Delegue a implementacao ao `integration-surgeon` depois que o plano for aceito ou o usuario pedir a alteracao.
